...
The testing trophy concept suggest 4 types of tests. Static, unit, integration and end-to-end, from bottom to top of the trophy. In this lab, syntax-checking by vi and type-checking by TypeScript represent static tests, `string.test.ts` represent unit tests, `content.test.ts` represent integration tests, and github actions represent end-to-end tests. Confidence of each test is built on the confidence of the test below it. The inregration test is the most valuable because it has the best balance between cost and confidence as a return. 